...
VistaUsuario.prototype = {
  ...
  reconstruirLista: function() {
    ...
    preguntas.forEach(function(clave){
      ...
      listaPreguntas.append($("<div>", {"val": clave.textoPregunta, "id": clave.id, "text": clave.textoPregunta}))
      var respuestas = clave.cantidadPorRespuesta;
  ...
  agregarVotos: function(){
    ...
    $('#preguntas').find('div').each(function(){
          //var nombrePregunta = $(this).attr('value');  -->  eso estaba antes
          var nombrePregunta = $(this).val(); //eso lo cambie yo
          var id = $(this).attr('id');
